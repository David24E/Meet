...
public class EditMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mDone = (ImageView) findViewById(R.id.ic_done);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(EditMapActivity.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void moveCamera(LatLng latLng, float zoom, String title){
        ...
        if(!title.equals("My Location")){
            ...
            EditMeetingFragment.mLocation.setText(title);
        }
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(EditMapActivity.this);
    }
