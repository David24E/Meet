...
public class AddMapActivity extends AppCompatActivity implements OnMapReadyCallback {
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AddMapActivity.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void moveCamera(LatLng latLng, float zoom, String title){
        ...
        if(!title.equals("My Location")){
            ...
            AddMeetingFragment.mLocation.setText(title);
        }
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(AddMapActivity.this);
    }
